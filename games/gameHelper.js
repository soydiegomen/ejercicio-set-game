...
function getDummyDeck(){
    ...
    cardsArray.push({ shape: SHAPE_DIAMOND, color: COLOR_PURPLE, number: 1, shading: SHADING_OUTLINED });
    ...
    cardsArray.push({ shape: SHAPE_OVAL, color: COLOR_GREEN, number: 1, shading: SHADING_STRIPED });
    cardsArray.push({ shape: SHAPE_OVAL, color: COLOR_GREEN, number: 1, shading: SHADING_STRIPED });
    cardsArray.push({ shape: SHAPE_DIAMOND, color: COLOR_RED, number: 3, shading: SHADING_STRIPED });
