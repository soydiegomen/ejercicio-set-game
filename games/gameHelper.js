...
function getDummyDeck(){
	...
	cardsArray.push({ shape: "TRES", color: COLOR_RED, number: 1, shading: SHADING_OUTLINED });
	...
	cardsArray.push({ shape: "UNO", color: COLOR_GREEN, number: 4, shading: SHADING_STRIPED });
	cardsArray.push({ shape: "UNO", color: COLOR_GREEN, number: 5, shading: SHADING_STRIPED });
	cardsArray.push({ shape: "TRES", color: COLOR_RED, number: 1, shading: SHADING_OUTLINED });
